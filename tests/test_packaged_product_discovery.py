...
from scripts.build_npm_package import copy_skill
...
class PackagedProductDiscoveryTests(unittest.TestCase):
    def test_npm_skill_copy_uses_the_canonical_archive_file_policy(self) -> None:
        with TemporaryDirectory() as directory:
            ...
            (source / "scripts" / "__pycache__" / "tool.pyc").write_bytes(b"bytecode")
            (source / "scripts" / "tool.pyo").write_bytes(b"optimized-bytecode")
